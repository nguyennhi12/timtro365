...
export default function Follow({route,navigation}) {
  const renderScene = SceneMap({
    ...
    const [routes] = React.useState([
        { key: 'first', title: 'ĐANG THEO DÕI', data:data},
        { key: 'second', title: 'ĐƯỢC THEO DÕI' ,data:data},
    ]);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.navigation}> 
                ...
                <Text style={{color:'white', fontWeight:'bold',fontSize:20, paddingTop:'1.5%'}}>Theo dõi</Text>
            </View>
            <TabView
