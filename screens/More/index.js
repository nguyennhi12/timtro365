...
import ForgotPasswordChangeScreen from '../components/ForgotPassword/Changepassword';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen component={ForgotPasswordScreen} name='Quên mật khẩu'/>
        <Stack.Screen component={ForgotPasswordChangeScreen} name='Đổi mật khẩu'/>
