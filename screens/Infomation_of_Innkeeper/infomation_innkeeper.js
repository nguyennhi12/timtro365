...
import {View,TouchableOpacity,Text,StyleSheet, ScrollView, ToastAndroid } from 'react-native';
        ...
        <View style={styles.container} >
          {/* header nè */}
           <View style={styles.navigation}> 
            ...
            <Text style={{color:'white', marginTop:'2%', fontSize:19, marginLeft:'4%', fontWeight:'bold'}}>{data[0].displayname}</Text>   
          </View>
          <ScrollView>
            {/* thông tin của người dùng */}
          <View style={{flexDirection:'row', padding:'3%', backgroundColor:'white'}}>
            ...
            <View>
              ...
              <View style={{flexDirection:'row'}}>
                {followidfollower==null?console.log("null"):<Text style={{marginTop:'3%', fontSize:12, marginLeft:'10%'}}>Số người theo dõi: {followidfollower.length}</Text>}
                {followid_user==null?console.log("null"): <Text style={{marginTop:'3%', fontSize:12, marginLeft:'10%'}}>Đang theo dõi: {followid_user.length}</Text>}
          ...
          <View style={styles.listItem}>
                ...
                {listnews!=null?listnews.map((item)=>(
